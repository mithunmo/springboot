...
/**
 * <p>Java class for trPaypalAdaptiveMessage complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="trPaypalAdaptiveMessage">
 *   &lt;complexContent>
...
@XmlType(name = "trPaypalAdaptiveMessage", propOrder = {
    "ack",
    "paykey",
    "timestamp",
    "build",
...
public class TrPaypalAdaptiveMessage implements Cloneable, CopyTo, Equals, HashCode, ToString
{
     ...
     * 
     */
    public TrPaypalAdaptiveMessage() {
        super();
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String thePaykey;
            thePaykey = this.getPaykey();
            strategy.appendField(locator, this, "paykey", buffer, thePaykey);
        }
        {
            String theTimestamp;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TrPaypalAdaptiveMessage)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TrPaypalAdaptiveMessage that = ((TrPaypalAdaptiveMessage) object);
        {
            String lhsAck;
            lhsAck = this.getAck();
            String rhsAck;
        ...
        {
            String lhsPaykey;
            lhsPaykey = this.getPaykey();
            String rhsPaykey;
            rhsPaykey = that.getPaykey();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "paykey", lhsPaykey), LocatorUtils.property(thatLocator, "paykey", rhsPaykey), lhsPaykey, rhsPaykey)) {
                return false;
            }
        }
        {
        ...
        {
            String lhsTransactionAmount;
            lhsTransactionAmount = this.getTransactionAmount();
            String rhsTransactionAmount;
            rhsTransactionAmount = that.getTransactionAmount();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "transactionAmount", lhsTransactionAmount), LocatorUtils.property(thatLocator, "transactionAmount", rhsTransactionAmount), lhsTransactionAmount, rhsTransactionAmount)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            String thePaykey;
            thePaykey = this.getPaykey();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "paykey", thePaykey), currentHashCode, thePaykey);
        }
        {
            String theTimestamp;
            theTimestamp = this.getTimestamp();
        ...
        }
        {
            String theTransactionAmount;
            theTransactionAmount = this.getTransactionAmount();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "transactionAmount", theTransactionAmount), currentHashCode, theTransactionAmount);
        }
        {
            String theSenderTransactionId;
            theSenderTransactionId = this.getSenderTransactionId();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TrPaypalAdaptiveMessage) {
            final TrPaypalAdaptiveMessage copy = ((TrPaypalAdaptiveMessage) draftCopy);
            if (this.ack!= null) {
                String sourceAck;
            ...
            if (this.paykey!= null) {
                String sourcePaykey;
                sourcePaykey = this.getPaykey();
                String copyPaykey = ((String) strategy.copy(LocatorUtils.property(locator, "paykey", sourcePaykey), sourcePaykey));
                copy.setPaykey(copyPaykey);
            } else {
                copy.paykey = null;
            }
            ...
            if (this.transactionAmount!= null) {
                String sourceTransactionAmount;
                sourceTransactionAmount = this.getTransactionAmount();
                String copyTransactionAmount = ((String) strategy.copy(LocatorUtils.property(locator, "transactionAmount", sourceTransactionAmount), sourceTransactionAmount));
                copy.setTransactionAmount(copyTransactionAmount);
            } else {
                copy.transactionAmount = null;
            }
