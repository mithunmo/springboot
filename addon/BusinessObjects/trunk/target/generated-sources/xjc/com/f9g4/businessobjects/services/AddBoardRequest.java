...
/**
 * <p>Java class for AddBoardRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AddBoardRequest">
 *   &lt;complexContent>
...
@XmlType(name = "AddBoardRequest", propOrder = {
    "board"
})
@XmlRootElement(name = "AddBoardRequest")
public class AddBoardRequest implements Cloneable, CopyTo, Equals, HashCode, ToString
{
     ...
     * 
     */
    public AddBoardRequest(final TrBoardDomain board) {
        this.board = board;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AddBoardRequest)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AddBoardRequest that = ((AddBoardRequest) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof AddBoardRequest) {
            final AddBoardRequest copy = ((AddBoardRequest) draftCopy);
            if (this.board!= null) {
