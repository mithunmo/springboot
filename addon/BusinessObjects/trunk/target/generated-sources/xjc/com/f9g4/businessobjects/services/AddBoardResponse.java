...
/**
 * <p>Java class for AddBoardResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AddBoardResponse">
 *   &lt;complexContent>
...
@XmlType(name = "AddBoardResponse", propOrder = {
    "board",
    "status"
})
@XmlRootElement(name = "AddBoardResponse")
public class AddBoardResponse implements Cloneable, CopyTo, Equals, HashCode, ToString
{
     ...
     * 
     */
    public AddBoardResponse(final TrBoardDomain board, final Status status) {
        this.board = board;
        this.status = status;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AddBoardResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AddBoardResponse that = ((AddBoardResponse) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof AddBoardResponse) {
            final AddBoardResponse copy = ((AddBoardResponse) draftCopy);
            if (this.board!= null) {
