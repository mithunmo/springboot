...
/**
 * <p>Java class for AddNotificationQWithMultiUsersResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AddNotificationQWithMultiUsersResponse">
 *   &lt;complexContent>
...
@XmlType(name = "AddNotificationQWithMultiUsersResponse", propOrder = {
    "status",
    "notificationQ"
})
@XmlRootElement(name = "AddNotificationQWithMultiUsersResponse")
public class AddNotificationQWithMultiUsersResponse implements Cloneable, CopyTo, Equals, HashCode, ToString
{
     ...
     * 
     */
    public AddNotificationQWithMultiUsersResponse() {
        super();
    }
     ...
     * 
     */
    public AddNotificationQWithMultiUsersResponse(final Status status, final List<TrNotificationQDomain> notificationQ) {
        this.status = status;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AddNotificationQWithMultiUsersResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AddNotificationQWithMultiUsersResponse that = ((AddNotificationQWithMultiUsersResponse) object);
        {
            Status lhsStatus;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof AddNotificationQWithMultiUsersResponse) {
            final AddNotificationQWithMultiUsersResponse copy = ((AddNotificationQWithMultiUsersResponse) draftCopy);
            if (this.status!= null) {
                Status sourceStatus;
