...
/**
 * <p>Java class for boardSet complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="boardSet">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="boardIds" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
@XmlType(name = "boardSet", propOrder = {
    "boardIds",
    "lastUpdateDate"
})
public class BoardSet implements Cloneable, CopyTo, Equals, HashCode, ToString
{

    protected int boardIds;
     ...
     * 
     */
    public BoardSet(final int boardIds, final XMLGregorianCalendar lastUpdateDate) {
     ...
     * 
     */
    public void setBoardIds(int value) {
        this.boardIds = value;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            int theBoardIds;
            theBoardIds = this.getBoardIds();
            strategy.appendField(locator, this, "boardIds", buffer, theBoardIds);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof BoardSet)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final BoardSet that = ((BoardSet) object);
        {
            int lhsBoardIds;
            lhsBoardIds = this.getBoardIds();
            int rhsBoardIds;
            rhsBoardIds = that.getBoardIds();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "boardIds", lhsBoardIds), LocatorUtils.property(thatLocator, "boardIds", rhsBoardIds), lhsBoardIds, rhsBoardIds)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            int theBoardIds;
            theBoardIds = this.getBoardIds();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "boardIds", theBoardIds), currentHashCode, theBoardIds);
        }
        {
            XMLGregorianCalendar theLastUpdateDate;
            theLastUpdateDate = this.getLastUpdateDate();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof BoardSet) {
            final BoardSet copy = ((BoardSet) draftCopy);
            int sourceBoardIds;
            sourceBoardIds = this.getBoardIds();
            int copyBoardIds = strategy.copy(LocatorUtils.property(locator, "boardIds", sourceBoardIds), sourceBoardIds);
            copy.setBoardIds(copyBoardIds);
