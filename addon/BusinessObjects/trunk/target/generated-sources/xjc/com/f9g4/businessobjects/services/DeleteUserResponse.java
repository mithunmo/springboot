...
public class DeleteUserResponse implements Cloneable, CopyTo, Equals, HashCode, ToString
{
     ...
     * 
     */
    public DeleteUserResponse(final Status status, final AdUsersDomain user) {
        this.status = status;
        this.user = user;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DeleteUserResponse)) {
            return false;
        }
        if (this == object) {
            return true;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof DeleteUserResponse) {
            final DeleteUserResponse copy = ((DeleteUserResponse) draftCopy);
            if (this.status!= null) {
                Status sourceStatus;
