...
/**
 * <p>Java class for GetAllSamplesResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetAllSamplesResponse">
 *   &lt;complexContent>
...
@XmlType(name = "GetAllSamplesResponse", propOrder = {
    "status",
    "samples"
})
@XmlRootElement(name = "GetAllSamplesResponse")
public class GetAllSamplesResponse implements Cloneable, CopyTo, Equals, HashCode, ToString
{
     ...
     * 
     */
    public GetAllSamplesResponse(final Status status, final List<TrBoardDomain> samples) {
        this.status = status;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetAllSamplesResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetAllSamplesResponse that = ((GetAllSamplesResponse) object);
        {
            Status lhsStatus;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof GetAllSamplesResponse) {
            final GetAllSamplesResponse copy = ((GetAllSamplesResponse) draftCopy);
            if (this.status!= null) {
                Status sourceStatus;
