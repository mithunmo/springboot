...
/**
 * <p>Java class for GetBoardsByPortfolioRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetBoardsByPortfolioRequest">
 *   &lt;complexContent>
...
@XmlType(name = "GetBoardsByPortfolioRequest", propOrder = {
    "portfolioid"
})
@XmlRootElement(name = "GetBoardsByPortfolioRequest")
public class GetBoardsByPortfolioRequest implements Cloneable, CopyTo, Equals, HashCode, ToString
{
     ...
     * 
     */
    public GetBoardsByPortfolioRequest() {
        super();
    }
     ...
     * 
     */
    public GetBoardsByPortfolioRequest(final int portfolioid) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetBoardsByPortfolioRequest)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetBoardsByPortfolioRequest that = ((GetBoardsByPortfolioRequest) object);
        {
            int lhsPortfolioid;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof GetBoardsByPortfolioRequest) {
            final GetBoardsByPortfolioRequest copy = ((GetBoardsByPortfolioRequest) draftCopy);
