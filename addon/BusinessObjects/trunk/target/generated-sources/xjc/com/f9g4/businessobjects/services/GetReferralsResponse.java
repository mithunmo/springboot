...
/**
 * <p>Java class for GetReferralsResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetReferralsResponse">
 *   &lt;complexContent>
...
@XmlType(name = "GetReferralsResponse", propOrder = {
    "status",
    "referrals"
})
@XmlRootElement(name = "GetReferralsResponse")
public class GetReferralsResponse implements Cloneable, CopyTo, Equals, HashCode, ToString
{
     ...
     * 
     */
    public GetReferralsResponse(final Status status, final List<TrReferralsDomain> referrals) {
        this.status = status;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetReferralsResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetReferralsResponse that = ((GetReferralsResponse) object);
        {
            Status lhsStatus;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof GetReferralsResponse) {
            final GetReferralsResponse copy = ((GetReferralsResponse) draftCopy);
            if (this.status!= null) {
                Status sourceStatus;
