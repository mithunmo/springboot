...
/**
 * <p>Java class for GetSecurityQuestionRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetSecurityQuestionRequest">
 *   &lt;complexContent>
...
@XmlType(name = "GetSecurityQuestionRequest", propOrder = {
    "userId"
})
@XmlRootElement(name = "GetSecurityQuestionRequest")
public class GetSecurityQuestionRequest implements Cloneable, CopyTo, Equals, HashCode, ToString
{
     ...
     * 
     */
    public GetSecurityQuestionRequest(final int userId) {
        this.userId = userId;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final GetSecurityQuestionRequest that = ((GetSecurityQuestionRequest) object);
        {
            int lhsUserId;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof GetSecurityQuestionRequest) {
            final GetSecurityQuestionRequest copy = ((GetSecurityQuestionRequest) draftCopy);
            int sourceUserId;
