...
public class GetUserbyEmailResponse implements Cloneable, CopyTo, Equals, HashCode, ToString
{
     ...
     * 
     */
    public GetUserbyEmailResponse(final AdUsersDomain user) {
        this.user = user;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetUserbyEmailResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetUserbyEmailResponse that = ((GetUserbyEmailResponse) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof GetUserbyEmailResponse) {
            final GetUserbyEmailResponse copy = ((GetUserbyEmailResponse) draftCopy);
            if (this.user!= null) {
