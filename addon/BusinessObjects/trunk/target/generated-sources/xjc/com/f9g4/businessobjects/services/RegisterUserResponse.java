...
public class RegisterUserResponse implements Cloneable, CopyTo, Equals, HashCode, ToString
{
     ...
     * 
     */
    public RegisterUserResponse(final Status status, final AdUsersDomain user) {
        this.status = status;
        this.user = user;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof RegisterUserResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final RegisterUserResponse that = ((RegisterUserResponse) object);
        {
            Status lhsStatus;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof RegisterUserResponse) {
            final RegisterUserResponse copy = ((RegisterUserResponse) draftCopy);
            if (this.status!= null) {
                Status sourceStatus;
