...
public class ResetPasswordResponse implements Cloneable, CopyTo, Equals, HashCode, ToString
{
     ...
     * 
     */
    public ResetPasswordResponse(final Status status) {
        this.status = status;
    }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ResetPasswordResponse) {
            final ResetPasswordResponse copy = ((ResetPasswordResponse) draftCopy);
            if (this.status!= null) {
                Status sourceStatus;
