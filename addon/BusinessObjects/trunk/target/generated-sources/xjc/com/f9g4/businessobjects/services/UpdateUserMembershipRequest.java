...
/**
 * <p>Java class for UpdateUserMembershipRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="UpdateUserMembershipRequest">
 *   &lt;complexContent>
...
@XmlType(name = "UpdateUserMembershipRequest", propOrder = {
    "user"
})
@XmlRootElement(name = "UpdateUserMembershipRequest")
public class UpdateUserMembershipRequest implements Cloneable, CopyTo, Equals, HashCode, ToString
{
     ...
     * 
     */
    public UpdateUserMembershipRequest() {
        super();
    }
     ...
     * 
     */
    public UpdateUserMembershipRequest(final AdUsersDomain user) {
        this.user = user;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UpdateUserMembershipRequest)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UpdateUserMembershipRequest that = ((UpdateUserMembershipRequest) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof UpdateUserMembershipRequest) {
            final UpdateUserMembershipRequest copy = ((UpdateUserMembershipRequest) draftCopy);
            if (this.user!= null) {
