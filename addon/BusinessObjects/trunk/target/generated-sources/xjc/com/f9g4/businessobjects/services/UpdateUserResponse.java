...
public class UpdateUserResponse implements Cloneable, CopyTo, Equals, HashCode, ToString
{
     ...
     * 
     */
    public UpdateUserResponse(final Status status, final AdUsersDomain user) {
        this.status = status;
        this.user = user;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UpdateUserResponse)) {
            return false;
        }
        if (this == object) {
            return true;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof UpdateUserResponse) {
            final UpdateUserResponse copy = ((UpdateUserResponse) draftCopy);
            if (this.status!= null) {
                Status sourceStatus;
