...
public class DesignWall {
	...
	private Integer useProfilename;
	...
	public Integer getUseProfilename() {
		return useProfilename;
	}

	public void setUseProfilename(Integer useProfilename) {
	...
	public DesignWall(String userName, BigDecimal salePrice, BigDecimal boardPrice,BigDecimal totalPrice, String name, Integer boardId,
			Calendar sellerPayDate, int paymentStatusId,String firstName, String lastName,String originalName,String thumbNailName, String fileType, String fileName, String profilename, Integer useProfilename) {
		super();
	...
	public String toString() {
		return "DesignWall [salePrice=" + salePrice + ", userName=" + userName
				...
				+ boardId + ", profilename= " + profilename + ", useProfilename=" + useProfilename +"]";
	}
