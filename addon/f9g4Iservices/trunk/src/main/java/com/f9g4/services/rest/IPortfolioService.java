...
public interface IPortfolioService {
	...
	@POST
	@Path("/contest/members/assign")
	public AssignMembersToContestResponse assignMembersToContest(AssignMembersToContestRequest request);
	
	@GET
	@Path("/contest/members/get/{portfolioId}")
	public GetContestMembersResponse getContestMembers(@PathParam("portfolioId") int portfolioid);
	
	@GET
	@Path(("/contest/{portfolioid}/{contestid}"))
	public GetContestDetailsResponse getContestDetails(@PathParam("portfolioid") int portfolioid, @PathParam("contestid") int contestid);
