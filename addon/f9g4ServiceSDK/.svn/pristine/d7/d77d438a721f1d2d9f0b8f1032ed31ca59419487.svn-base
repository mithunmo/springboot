package com.f9g4.servicesdk.stub;
...
public class NotificationQServiceStub implements INotificationQService {
	...
	public DeleteNotificationQByIdResponse deleteNotificationQById(int referralsid) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	public GetEmailTemplateByCodeResponse getEmailTemplateByCode(
			String templateCode) {
		// TODO Auto-generated method stub
		return null;
	}

	public GetEmailTemplateByCodeContainingResponse getEmailTemplateByCodeContaining(
			String templateCode) {
		// TODO Auto-generated method stub
		return null;
	}

	public AddNotificationQWithMultiUsersResponse addNotificationQWithMultiUsers(
			AddNotificationQWithMultiUsersRequest request) {
		// TODO Auto-generated method stub
		return null;
	}
}
