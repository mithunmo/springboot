...
public class TrPortfolioImagesDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private TrPortfolioImagesDAO dataStore;

	/**
	 * Instantiates a new TrPortfolioImagesDAOTest.
	 *
	 */
	public TrPortfolioImagesDAOTest() {
	}
	...
	@Rollback(false)
	@Test
	public void TrPortfolioImages() {
		TrPortfolioImages instance = new TrPortfolioImages();
	 ...
	 */
	@Autowired
	public void setDataStore(TrPortfolioImagesDAO dataStore) {
