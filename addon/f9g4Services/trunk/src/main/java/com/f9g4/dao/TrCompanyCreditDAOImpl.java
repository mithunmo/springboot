 ...
 * 
 */
@Repository("TrCompanyCreditDAO")
@Transactional
public  class TrCompanyCreditDAOImpl extends AbstractJpaDao<TrCompanyCredit>
		implements TrCompanyCreditDAO {

	/**
	 * Set of entity classes managed by this DAO.  Typically a DAO manages a single entity.
	 *
	 */
	private final static Set<Class<?>> dataTypes = new HashSet<Class<?>>(Arrays.asList(new Class<?>[] { TrCompanyCredit.class }));
	...
	@Override
	public boolean canBeMerged(TrCompanyCredit o) {
