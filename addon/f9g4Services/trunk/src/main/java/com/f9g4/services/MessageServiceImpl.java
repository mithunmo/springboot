...
public class MessageServiceImpl implements IMessageService {
	...
	private TrMessagesDomain convertEntityToDomain(TrMessages entity) throws DatatypeConfigurationException{
		...
		domain.setFromUserProfilename(entity.getAdUsersByFromUserId().getProfilename());
		domain.setFromUserUseProfilename(entity.getAdUsersByFromUserId().getUseProfilename());
		domain.setToUserProfilename(entity.getAdUsersByToUserId().getProfilename());
		domain.setToUserUseProfilename(entity.getAdUsersByToUserId().getUseProfilename());
		return domain;
