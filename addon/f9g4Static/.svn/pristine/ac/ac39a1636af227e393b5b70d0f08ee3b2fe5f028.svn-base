(function($) {
				...
				items  = (function() {
					...
					select.children('option').each(function(i, option) {
						...
						str += o.item
							...
							.replace(/%disabled%/i, option.attr('disabled') ? 'disabled="disabled"' : '')
	...
	$.fn.multiselect.defaults = {
		 ...
		 * @type  String
		 */
		item : '<div  class="mselect-list-item"><label><input type="checkbox" value="%value%" %checked% %disabled%/>%label%</label></div>',
		/**
