...
function buildUploadPopup(options)
{
	...
	var defaultOptions = {
		"url": null,
		"mode": "BOARD", //Two options: LOGO | BOARD
		"filetype": "jpg",
	...
	options.loadComplete= function() {
		...
		$('#uploadify').uploadify(
		{
	        ...
	        'onUploadSuccess' : function(file, data, response) 
	        {
	            ...
	            {
	            	$("#popup_upload .upload_info .description").html('The upload process is timeout.');
	            }
	        }
		 });
	}
...
function buildPopupMsg(options)
{
	...
	options=$.extend({},defaultOptions,options);
	logging("buildPopup=>"+options.content);
...
//Close error msg====================================================
function closePopupMsg(callback)
{
	var target="#error";
...
//confirmation popup
function showConfirmation(content,title,event,eventHandler)
{
	buildPopupMsg({
