...
<div class="splash-header">
	<div class="header-functions">
		...
		<div class="right-holder">
			...
			<map name="funstions-map">
  			...
  			<area shape="rect" coords="150,0,219,21" href="${pageContext.request.contextPath}<%= ViewPaths.REGISTRATION_DESIGNER %>" title="SIGN UP" alt="SIGN UP" id="mapSignUp">
			</map> --%>
		</div>
	</div>
	<div class="logo">
	...
	<div class="header-buttons">
		<a href="${pageContext.request.contextPath}<%= ViewPaths.ABOUT_US %>" id="who"></a>
		<a href="${pageContext.request.contextPath}<%= ViewPaths.WHAT_WE_DO %>" id="what"></a>
		<%-- <a href="${pageContext.request.contextPath}<%= ViewPaths.HOW_IT_WORKS %>" id="how"></a> --%>
		<a href="${pageContext.request.contextPath}<%= ViewPaths.GET_STARTED %>" id="freeDemo"></a>
