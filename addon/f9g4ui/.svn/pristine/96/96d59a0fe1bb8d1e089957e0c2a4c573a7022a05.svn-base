...
//Projects
	...
	,pauseProjectPath:appPath+"<%= ViewPaths.ADMIN_PROJECTS_PAUSE_PROJECT%>"
	,resumeProjectPath:appPath+"<%= ViewPaths.ADMIN_PROJECTS_RESUME_PROJECT%>"
	,completeProjectPath:appPath+"<%= ViewPaths.ADMIN_PROJECTS_COMPLETE_PROJECT%>"
	,getProjectDetail:appPath+"<%= ViewPaths.ADMIN_PROJECTS_PROJECT_DETAIL%>"
	...
	,previewCBDPath:appPath+"<%= ViewPaths.ADMIN_PROJECTS_VIEW_CREATIVE_BRIEF_DETAIL_PREVIEW%>"
//Dashboard
