								...
								<c:otherwise>
									<div class="tilesView" id="messageTiles">
										...
										<c:forEach var="item" items="${messageList}" varStatus="counter">
											...
											<div class="Tile" data="${item.boardId}_${item.fromUserId}_${item.toUserId}">
													...
													<div class="senderInfo">
														...
														<br />
															<span>
																...
																${item.fromUserFirstName}&nbsp;${item.fromUserLastName}<c:if test="${item.fromUserIsCompany}">&nbsp;(${item.fromUserCompanyName})</c:if>
																</a>
															</span>
														<br />
												...
												<div class="touchArea" href="javascript:void(0);" data="${item.boardId}_${item.fromUserId}_${item.toUserId}">1234</div>
												<c:choose>
						        	...
						        	<c:forEach var="item" items="${messageList}" varStatus="counter">
						        		...
						        		<div class="message <c:if test="${counter.count%2==1}">odd</c:if> <c:if test="${counter.count%2==0}">even</c:if>">
							                ...
							                <div class="sender">
							                	<table>
							                		<tr><td><a href="javascript:void(0)" class="messages_fromUserId" data="${item.fromUserId}"><div class="userNameLabel font-header wordClip">${item.fromUserFirstName}&nbsp;${item.fromUserLastName}<c:if test="${item.fromUserIsCompany}">&nbsp;(${item.fromUserCompanyName})</c:if></div></a></td></tr>
