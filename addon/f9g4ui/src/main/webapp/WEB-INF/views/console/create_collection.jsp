...
<div class="contentFrame" >
    ...
    <form:form action="" modelAttribute="createPortfolioForm" id="form_create_collection" method="POST">
    	<div class="info">The information you select will apply to your new collection and any boards stored within it.</div>
        <div class="portfolio">
        	<div class="name">
        		<div class="label" id="label_portfolio_name">Collection Name</div>
                <br />
                <!-- <input name="name_of_portfolio" id="form_name_of_portfolio" type="text" /> -->
                <form:input path="portfolioName" id="form_name_of_portfolio" disabled="${editMode}" maxlength="300" class="width_controller" />
            </div>
            <div class="description">
            	<div class="label" id="label_portfolio_description">Collection Description</div>
                <br />
                <!-- <input name="description_of_portfolio" id="form_description_of_portfolio" type="text" /> -->
                <form:input path="portfolioDescription" id="form_description_of_portfolio" disabled="${editMode}" maxlength="300" class="width_controller"/>
            </div>
        </div>
        <div class="detail">
        	<div class="leftArea">
        ...
        <div class="images-section">
        	...
        	<div class="images-section-item hint" style="width:50%;">
        		*Please upload up to 2 inspiration photos or mood boards. These images will be attached to each design board within this collection.
        	</div>
        </div>
        ...
        <div class="buttons">
        	...
        	<c:choose>
        		<c:when test="${editMode}">
        			<div class="button critical delete_portfolio" id="delete_portfolio" data-mode="c" data="${portfolio.portfolioId}">Delete</div>
        			<div class="button orange" id="back_to_boards" data-mode="c" data-portfolio="${portfolio.portfolioId}">Cancel</div>
        		</c:when>
        		<c:otherwise>
        			<div class="button orange" id="cancel_create_portfolio" data-mode="c">Cancel</div>
        		</c:otherwise>
        	</c:choose>
            <div class="button" id="save_create_portfolio" data-mode="c" button-disabled="false" edit-mode="${editMode}">Save</div>
        </div>
    </form:form>
    </div>
</div>
