...
<!-- Data Table -->
<table class="projects-viewer pv-c">
	<thead>
		<tr>
			...
			<th><a href="javascript:void(0);" class="glyphicon {{sortIcon[3]}}" ng-click="sort(3)"></a>Season</th>
			<th><a href="javascript:void(0);" class="glyphicon {{sortIcon[4]}}" ng-click="sort(4)"></a>Doc</th>
			<th><a href="javascript:void(0);" class="glyphicon {{sortIcon[5]}}" ng-click="sort(5)"></a>Status</th>
	...
	<tbody>
		<tr class="proj-nav" ng-repeat="item in displayData" ng-click="boardsView(item.originalData.contestPortfolioDomain.portfolioId,item.originalData.contestId)">
			...
			<td><span class="proj-status" ng-class="{r: item.contestStatusMap['0'] || item.contestStatusMap['2'], g: item.contestStatusMap['1'] || item.contestStatusMap['4'], b: item.contestStatusMap['5'], gr: item.contestStatusMap['3']}">{{item.contestStatus}}</span></td>
