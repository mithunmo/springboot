							...
							<c:when test="${!empty boardList}">
									...
									<c:forEach var="item" items="${boardList}" varStatus="counter">
										...
										<div class="Tile">
											...
											<div class="tile-content">
												...
												<a href="javascript:void(0)" class="userinfo" data="${item.userName}">${item.designerName}</a>
												<br />
												$${item.totalPrice}
												<br />
								...
								<table>
					              ...
					              <tr>
					                ...
					                <td><a href="javascript:void(0)" class="userinfo" data="${item.userName}">${item.designerName}</a></td>
