	...
	<div class="header-holder">
		...
		--><div class="header-holder-functions">
			<div class="items">
				...
				<div class="item"><a href="${pageContext.request.contextPath}<%= ViewPaths.USER_PROJECTS_VIEW_PROJECTS%>" target="_self">My Work</a></div>
				<div class="item"><a href="${pageContext.request.contextPath}<%= ViewPaths.TAB_DESIGNER_ACCOUNT%>" target="_self">Account</a></div>
